//Define the AVLogApp, and hang it off the window so that it can have other definitions hung off of it.
...
window.AVLogApp = new Backbone.Marionette.Application();