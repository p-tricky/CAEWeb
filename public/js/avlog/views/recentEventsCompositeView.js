...
AVLogApp.module('AVLogClassroomTab', function (AVLogClassroomTab, App, Backbone, Marionette, $, _) {
  ...
  AVLogClassroomTab.RecentEventsCompositeView = Backbone.Marionette.CompositeView.extend({

    //Define the ItemView counterpart to be used with this view.    
    itemView: AVLogApp.AVLogClassroomTab.RecentEventsItemView,
    ...
    initialize : function(options) {
      ...
      this.template = Handlebars.compile(tpl.get('recentEventsLogDetails'));
