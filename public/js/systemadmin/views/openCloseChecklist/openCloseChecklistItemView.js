...
SysAdminApp.module('OpenCloseChecklistTab', function (OpenCloseChecklistTab, App, Backbone, Marionette, $, _) {
  ...
  OpenCloseChecklistTab.OpenCloseChecklistItemView = Backbone.Marionette.ItemView.extend({
    ...
    initialize : function(options) {
      ...
      this.template = Handlebars.compile(tpl.get('openclosechecklist/_checklistRow'));
    ...
    attributes : function(){
      ...
      var classValue = this.model.get('checklistNumber');
