...
SysAdminApp.module('CheckoutLabTab', function (CheckoutLabTab, App, Backbone, Marionette, $, _) {
  ...
  CheckoutLabTab.CheckoutLabDetailsModalView = Backbone.Marionette.CompositeView.extend({
    ...
    initialize : function() {
      ...
      this.template = Handlebars.compile(tpl.get('checkoutlab/checkoutDetailsModal'));
    },
